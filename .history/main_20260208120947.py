...
def main():
	...
	with st.sidebar:
		...
		with st.expander('Account Balances'):
			...
			tda_start = st.number_input('Tax-deferred account starting balance (IRA/401k) - person 1', value=7.0, step=1000.0)
		...
		with st.expander('Tax Settings'):
			...
			inheritor_marginal_rate = st.number_input(
				...
				value=0.35, min_value=0.0, max_value=0.37, format="%.4f")
